...
[
  {user_id: '1', name: 'Wells Fargo', status: 'primary', balance: 1200000, currency: 'USD', description: 'US account'},
  {user_id: '1', name: 'Deutsche Bank', status: 'secondary', balance: 2400000, currency: 'EUR', description: nil},
].each do |bank_account_attributes|
